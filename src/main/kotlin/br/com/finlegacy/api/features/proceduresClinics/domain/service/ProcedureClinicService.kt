...
interface ProcedureClinicService {
    ...
    suspend fun findProceduresByClinicId(clinicId: Long, uidLogged:String): Result<List<ProcedureClinicInfo>>
    suspend fun findClinicByProcedureId(procedureId: Long, uidLogged:String): Result<List<ProcedureClinicInfo>>
}