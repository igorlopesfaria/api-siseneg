    ...
    override suspend fun update(patientUpdate: PatientUpdate, clinicId: Long): PatientInfo? {
        return suspendTransaction {
            ...
            PatientEntity.findByIdAndUpdate(patientUpdate.id) { item ->
                ...
                item.addressCEP = patientUpdate.addressCEP
                item.addressStreet = patientUpdate.addressStreet
                item.addressNumber = patientUpdate.addressNumber
                item.addressNeighborhood = patientUpdate.addressNeighborhood
                item.addressCity = patientUpdate.addressCity
                item.addressState = patientUpdate.addressState
    ...
    override suspend fun create(patientCreate: PatientCreate, clinicId: Long): PatientInfo {
        return suspendTransaction {
            ...
            PatientEntity.new {
                ...
                this.addressCEP = patientCreate.addressCEP
                this.addressStreet = patientCreate.addressStreet
                this.addressNumber = patientCreate.addressNumber
                this.addressNeighborhood = patientCreate.addressNeighborhood
                this.addressCity = patientCreate.addressCity
                this.addressState = patientCreate.addressState
